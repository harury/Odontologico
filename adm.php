        ...
        <table class="table border table-striped">
          ...
          ?>
            <tr>
              ...
              <td>
                <a class="btn btn-warning btn-sm"  style="color:#fff" href="editarAtendimento.php?id=<?php echo $array['id_especialidade'] ?>" role="button"><i class="fa fa-pencil-square-o"></i></a> 
                <a class="btn btn-danger btn-sm"  style="color:#fff" onclick = "excluirAtendimento(<?php echo $array['id_especialidade']?>)" role="button"><i class="fa fa-trash-o"></i></a>
              </td>
            </tr>  
          <?php } ?>
          </tbody>
